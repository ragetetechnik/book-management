...
exports.up = function(knex) {
    return knex.schema
        ...
        .createTable('books', function (table) {
            ...
            table.integer('publisher_id').unsigned().references('id').inTable('publishers').onDelete('RESTRICT')
        ...
        .createTable('book_author', function (table) {
            ...
            table.integer('author_id').unsigned().references('id').inTable('authors').onDelete('RESTRICT')
            table.timestamp('created_at').defaultTo(knex.fn.now())
            table.timestamp('updated_at').defaultTo(knex.raw('NULL ON UPDATE CURRENT_TIMESTAMP'))
        })
}
